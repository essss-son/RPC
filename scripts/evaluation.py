...
def main(args):
    txt_list = []
    neg_txt = args.txt + f'imdb_negative_64_ck7_JS.txt'
    pos_txt = args.txt + f'imdb_positive_64_ck7_JS.txt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--txt', type=str, default="/root/autodl-tmp/FT/air/air/test_data/new_generates/", help='txt file contains text to be evaluated')
