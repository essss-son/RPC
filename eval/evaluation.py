...
def main(args):
    txt_list = []
    neg_txt = args.txt + f'gpt2_medium_imdb_attr0.txt'
    pos_txt = args.txt + f'gpt2_medium_imdb_attr1.txt'
    neg_txt = args.txt + args.attr0_txt
    pos_txt = args.txt + args.attr1_txt
...
if __name__ == '__main__':
    ...
    parser.add_argument('--txt', type=str, default="/root/autodl-tmp/FT/attr/gen/sent_30prefix/2048-mid-dim-128data-10epochs-128length/", help='txt file contains text to be evaluated')
