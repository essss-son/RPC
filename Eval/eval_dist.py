...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", default="/home/anke/DXZ/RPC/rpc-new/output/sentiment_output_0.9_384.json", type=str)
    parser.add_argument("--model_name_or_path", default=None, type=str)
    args = parser.parse_args()

    tokenizer = RobertaTokenizer.from_pretrained("/home/anke/DXZ/models/roberta-large-tokenizer")
    ...
    with open(write_path, "a") as f:
        obj = {
            ...
            "dist1": float('{:.3f}'.format(dist1)),
            "dist2": float('{:.3f}'.format(dist2)),
            "dist3": float('{:.3f}'.format(dist3)),
        }
        json.dump(obj, f)
        f.write("\n")